Shader "Custom/Lit/Uber Shader"
{
    Properties
    {
       ...
       [HideInInspector]  _DetailAlbedoMap("Detail Albedo x2", 2D) = "linearGrey" {}
        ...
        _Dirtiness("Dirtiness", Range(0, 1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            inline void InitializeStandardLitSurfaceDataWithTriplanar(float2 uv, float3 positionWS, float3 normalWS, out SurfaceData outSurfaceData)
            {
                ...
                albedoAlpha = lerp(albedoAlpha, dirt, _Dirtiness);
            ...
            )
            {
                ...
                InitializeStandardLitSurfaceDataWithTriplanar(input.uv, input.positionWS, input.normalWS, surfaceData);
